...
{
    public class Ruderibus_Box : ModItem
    {
        public override void SetStaticDefaults()
        {
            ...
            MusicLoader.AddMusicBox(Mod, MusicLoader.GetMusicSlot(Mod, "Music/Frigid_Predator"), ModContent.ItemType<Ruderibus_Box>(), ModContent.TileType<Ruderibus_Music_Box>());
        }

        public override void SetDefaults()
        {
            Item.DefaultToMusicBox(ModContent.TileType<Ruderibus_Music_Box>(), 0);
        }
    }
}