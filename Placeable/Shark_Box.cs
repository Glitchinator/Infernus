...
{
    public class Shark_Box : ModItem
    {
        public override void SetStaticDefaults()
        {
            ...
            MusicLoader.AddMusicBox(Mod, MusicLoader.GetMusicSlot(Mod, "Music/Eye_of_the_Ocean"), ModContent.ItemType<Shark_Box>(), ModContent.TileType<Shark_Music_Box>());
        }

        public override void SetDefaults()
        {
            Item.DefaultToMusicBox(ModContent.TileType<Shark_Music_Box>(), 0);
        }
    }
}