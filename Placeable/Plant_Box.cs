...
{
    public class Plant_Box : ModItem
    {
        public override void SetStaticDefaults()
        {
            ...
            MusicLoader.AddMusicBox(Mod, MusicLoader.GetMusicSlot(Mod, "Music/Floral_Disruption"), ModContent.ItemType<Plant_Box>(), ModContent.TileType<Plant_Music_Box>());
        }

        public override void SetDefaults()
        {
            Item.DefaultToMusicBox(ModContent.TileType<Plant_Music_Box>(), 0);
        }
    }
}