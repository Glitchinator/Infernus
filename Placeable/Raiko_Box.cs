...
{
    public class Raiko_Box : ModItem
    {
        public override void SetStaticDefaults()
        {
            ...
            MusicLoader.AddMusicBox(Mod, MusicLoader.GetMusicSlot(Mod, "Music/Provenance_17"), ModContent.ItemType<Raiko_Box>(), ModContent.TileType<Raiko_Music_Box>());
        }

        public override void SetDefaults()
        {
            Item.DefaultToMusicBox(ModContent.TileType<Raiko_Music_Box>(), 0);
        }
    }
}