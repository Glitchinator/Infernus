...
{
    public class Wanderer_Box : ModItem
    {
        public override void SetStaticDefaults()
        {
            ...
            MusicLoader.AddMusicBox(Mod, MusicLoader.GetMusicSlot(Mod, "Music/The_Wanderer"), ModContent.ItemType<Wanderer_Box>(), ModContent.TileType<Wanderer_Music_Box>());
        }

        public override void SetDefaults()
        {
            Item.DefaultToMusicBox(ModContent.TileType<Wanderer_Music_Box>(), 0);
        }
    }
}