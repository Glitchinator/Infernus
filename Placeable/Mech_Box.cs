...
namespace Infernus.Placeable
{
    public class Mech_Box : ModItem
    {
        public override void SetStaticDefaults()
        {
            ...
            MusicLoader.AddMusicBox(Mod, MusicLoader.GetMusicSlot(Mod, "Music/Divine_Fight"), ModContent.ItemType<Mech_Box>(), ModContent.TileType<Mech_Music_Box>());
        }

        public override void SetDefaults()
        {
            Item.DefaultToMusicBox(ModContent.TileType<Mech_Music_Box>(), 0);
        }
    }
}