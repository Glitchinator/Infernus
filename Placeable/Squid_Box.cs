...
{
    public class Squid_Box : ModItem
    {
        public override void SetStaticDefaults()
        {
            ...
            MusicLoader.AddMusicBox(Mod, MusicLoader.GetMusicSlot(Mod, "Music/Inked_Vortex"), ModContent.ItemType<Squid_Box>(), ModContent.TileType<Squid_Music_Box>());
        }

        public override void SetDefaults()
        {
            Item.DefaultToMusicBox(ModContent.TileType<Squid_Music_Box>(), 0);
        }
    }
}