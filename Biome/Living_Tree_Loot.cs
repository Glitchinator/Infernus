...
{
    public class Living_Tree_Loot : ModSystem
    {
        ...
        public override void PostWorldGen()
        {
            ...
            for (int chestIndex = 0; chestIndex < Main.maxChests; chestIndex++)
            {
                ...
                if (chestTile.TileType == TileID.Containers && (chestTile.TileFrameX == 21 * 36))
                {
                    ...
                    for (int inventoryIndex = 0; inventoryIndex < Chest.maxItems; inventoryIndex++)
                    {
                        ...
                        {
                            // Place the item
                            chest.item[inventoryIndex].SetDefaults(ModContent.ItemType<Morning_Dew>());
