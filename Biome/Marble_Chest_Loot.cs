...
{
    public class Marble_Chest_Loot : ModSystem
    {
        ...
        public override void PostWorldGen()
        {
            ...
            for (int chestIndex = 0; chestIndex < Main.maxChests; chestIndex++)
            {
                ...
                if (chestTile.TileType == TileID.Containers && (chestTile.TileFrameX == 51 * 36 || chestTile.TileFrameX == 50 * 36))
                {
                    ...
                    for (int inventoryIndex = 0; inventoryIndex < Chest.maxItems; inventoryIndex++)
                    {
                        ...
                        {
                            // Place the item
                            chest.item[inventoryIndex].SetDefaults(ModContent.ItemType<Ancient_Incantation>());
