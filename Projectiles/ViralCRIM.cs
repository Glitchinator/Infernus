...
{
    public class ViralCRIM : ModProjectile
    {
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            target.AddBuff(ModContent.BuffType<Rot_Ball_Crim>(), 240);
        }
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Asset<Texture2D> chainTexture = ModContent.Request<Texture2D>("Infernus/Projectiles/ViralCRIM_Chain");
            ...
            for (int k = 0; k < Projectile.oldPos.Length; k++)
            {
                ...
                Main.EntitySpriteDraw(texture, drawPos, null, new Color(222, 38, 56, 0) * (.60f - Projectile.alpha / 210f), Projectile.rotation, drawOrigin2, Projectile.scale, spriteEffects2, 0);
            }
