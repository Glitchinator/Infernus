...
{
    public class Whiprock : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            for (int i = 0; i < list.Count - 1; i++)
            {
                ...
                if (i == list.Count - 2)
                {
                    ...
                    {
                        int whip = Dust.NewDust(pos, Projectile.width, Projectile.height, Main.rand.Next(new int[] { DustID.Stone, DustID.Grass }), Projectile.velocity.X, Projectile.velocity.Y);
