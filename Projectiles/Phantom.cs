    ...
    public class Phantom : ModProjectile
    {
        ...
        public override void AI()
        {
            if (Main.rand.NextBool(3))
            {
                ...
                Dust.NewDust(Projectile.position + Projectile.velocity, Projectile.width, Projectile.height, DustID.Ghost, Projectile.velocity.X * 0.5f, Projectile.velocity.Y * 0.5f);
            }
