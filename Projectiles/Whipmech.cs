...
namespace Infernus.Projectiles
{
    public class Whipmech : ModProjectile
    {
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            target.AddBuff(ModContent.BuffType<Whipbuff>(), 300);
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            for (int i = 0; i < list.Count - 1; i++)
            {
                ...
                if (i == list.Count - 2)
                {
                    ...
                    {
                        int whip = Dust.NewDust(pos, Projectile.width, Projectile.height, DustID.Wraith, Projectile.velocity.X, Projectile.velocity.Y);
