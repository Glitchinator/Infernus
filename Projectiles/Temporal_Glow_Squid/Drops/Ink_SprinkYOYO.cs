...
namespace Infernus.Projectiles.Temporal_Glow_Squid.Drops
{
    ...
    public class Ink_SprinkYOYO : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            {
                Projectile.NewProjectile(Terraria.Entity.GetSource_NaturalSpawn(), Projectile.Center.X, Projectile.Center.Y, Main.rand.Next(-10, 11), Main.rand.Next(-10, -5), ModContent.ProjectileType<Ink_Sprink>(), 12, 0, Projectile.owner);
            }
        }
    }
}