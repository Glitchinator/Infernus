...
namespace Infernus.Projectiles
{
    ...
    public class Terra_Shot : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            for (int k = 0; k < Projectile.oldPos.Length; k++)
            {
                ...
                Main.EntitySpriteDraw(texture, drawPos, null, new Color(240, 98, 186, 0) * (.80f - Projectile.alpha / 210f), Projectile.rotation, drawOrigin, Projectile.scale, spriteEffects, 0);
            }
