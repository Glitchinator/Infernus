...
namespace Infernus.Projectiles
{
    ...
    public class Fart_Sword_Energy : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Main.rand.NextFloat() * 2f < Projectile.Opacity)
            {
                ...
                Color dustColor = Color.Lerp(Color.LimeGreen, Color.White, Main.rand.NextFloat() * 0.3f);
            ...
            if (Main.rand.NextFloat() * 1.5f < Projectile.Opacity)
            {
                ...
                Dust.NewDustPerfect(dustPosition, DustID.TintableDustLighted, dustVelocity, 100, Color.LimeGreen * Projectile.Opacity, 1.2f * Projectile.Opacity);
            }
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Color backDarkColor = new Color(16, 134, 75); // Original Excalibur color: Color(180, 160, 60)
            Color middleMediumColor = new Color(47, 174, 89); // Original Excalibur color: Color(255, 255, 80)
            Color frontLightColor = new Color(7, 242, 85); // Original Excalibur color: Color(255, 240, 150)
