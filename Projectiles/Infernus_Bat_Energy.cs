...
namespace Infernus.Projectiles
{
    ...
    public class Infernus_Bat_Energy : ModProjectile
    {
        public override string Texture => "Infernus/Projectiles/Aeritite_Sword_Energy";
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Color backDarkColor = new Color(243, 175, 32); // Original Excalibur color: Color(180, 160, 60)
            Color middleMediumColor = new Color(255, 179, 49); // Original Excalibur color: Color(255, 255, 80)
            Color frontLightColor = new Color(255, 215, 75); // Original Excalibur color: Color(255, 240, 150)
