...
{
    public class Piss_Shit_Fart_Sword : ModItem
    {
        ...
        public override void AddRecipes()
        {
            ...
            .AddIngredient(ItemID.PoopBlock, 4)
        ...
        public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
        {
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                Projectile.NewProjectile(source, position, heading, ModContent.ProjectileType<Homing_Piss>(), damage, knockback, player.whoAmI, 0f, 0);
            }
