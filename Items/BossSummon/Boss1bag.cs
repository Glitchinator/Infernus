...
namespace Infernus.Items.BossSummon
{
    public class Boss1bag : ModItem
    {
        ...
        public override void ModifyItemLoot(ItemLoot itemLoot)
        {
            ...
            itemLoot.Add(ItemDropRule.Common(ModContent.ItemType<Weapon.Summon.Minion>(), 2));
            itemLoot.Add(ItemDropRule.Common(ModContent.ItemType<Weapon.Magic.MeteorEater>(), 2));
