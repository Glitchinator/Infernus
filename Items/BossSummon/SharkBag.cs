...
namespace Infernus.Items.BossSummon
{
    public class SharkBag : ModItem
    {
        ...
        public override void ModifyItemLoot(ItemLoot itemLoot)
        {
            ...
            itemLoot.Add(ItemDropRule.Common(ModContent.ItemType<Weapon.HardMode.Ranged.Lightning_Daggers>(), 1, 175, 2580));
            ...
            itemLoot.Add(ItemDropRule.Common(ModContent.ItemType<Weapon.HardMode.Accessories.eleScale>()));
